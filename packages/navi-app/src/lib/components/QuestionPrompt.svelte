            ...
            >
              <div class="flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  {/if}
                  {#if option.preview}
                    <!-- HTML preview generated by the model; SDK strips script/style before it reaches us -->
                    <div class="mt-2 rounded-md border border-gray-200 bg-white p-2 overflow-hidden pointer-events-none">
                      {@html option.preview}
                    </div>
                  {/if}
                </div>
