...
function getModelDescription(model: string, backend: string): string {
  const descriptions: Record<string, string> = {
    // Codex
    "gpt-5.6-sol": "Default agentic coding model",
    "gpt-5.6-luna": "Balanced GPT-5.6 variant",
    "gpt-5.6-terra": "Long-horizon GPT-5.6 variant",
    "gpt-5.6-pro": "Highest capability, slowest",
    "gpt-5.6": "Base GPT-5.6",
    "gpt-5.5": "Previous generation",
    "gpt-5.4": "Older general model",
    "gpt-5.4-mini": "Smaller, faster",
    "gpt-5.4-nano": "Lowest latency",
    "gpt-5.3-codex": "Legacy Codex model (needs an API key)",
    "gpt-5.2-codex": "Legacy Codex model (needs an API key)",
    "gpt-5.2": "Legacy general model",
    "gpt-5-codex": "Legacy Codex model (needs an API key)",
    "codex-mini-latest": "Lightweight Codex model",
    "gpt-5.1-codex-max": "Legacy: maximum capability",
    "gpt-5.1-codex": "Legacy: standard agentic model",
    "gpt-5.1-codex-mini": "Legacy: fast & efficient",
