...
The UI has a built-in browser/preview panel that can display:
...
1. For web apps: "Start your dev server, then open http://localhost:3000 in the browser panel"
2. For files: "You can preview this file using the Files panel on the right"
3. For markdown: "Open it from the Files panel to see the rendered markdown"
